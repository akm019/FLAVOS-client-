  ...
  return (
    <div className="md:flex justify-around gap-28 text-white p-10 bg-black">
      <div className="text-center">
        ...
        <div ref={usersRef}>
          {usersInView && <CountUp end={10000} duration={3} className="text-5xl lg:text-6xl font-bold text-red-500" />}<span className='text-6xl font-bold text-red-500'>+</span>
        </div>
      </div>
      <div className="text-center">
        <h2 className="text-4xl sm:text-4xl font-bold">5 Star Reviews</h2>
        <div ref={reviewsRef}>
          {reviewsInView && <CountUp end={500} duration={3} className="text-5xl lg:text-6xl font-bold text-red-500" />}<span className='text-6xl font-bold text-red-500'>+</span>
        </div>
      </div>
      <div className="text-center">
        <h2 className="text-4xl  font-bold">Daily Orders</h2>
        <div ref={ordersRef}>
          {ordersInView && <CountUp end={300} duration={3} className="text-5xl font-bold text-red-500" />}<span className='text-6xl font-bold text-red-500'>+</span>
        </div>
      </div>
    </div>
  );
